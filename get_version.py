...
def get_CN_android_version() -> str | None:
...
def get_play_store_ver(region: str) -> str | None:
    if region == "CN":
...
def get_app_store_ver(region: str) -> str | None:
